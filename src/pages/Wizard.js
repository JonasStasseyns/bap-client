            ...
            {step===1 &&
                <div className="wizard-container">
                    <div className="wizard-info-section">
                        ...
                        <p>Naast de verschillende toestel-types, zijn er ook verschillende mogelijkheden om hem te installeren.</p>

                        <h3>A. Volledig door één onderneming</h3>
                        <p>Dit is de gemakkelijkste, maar minst flexibele oplossing. Wanneer je kiest om de aankoop, plaatsing én opstart te laten verzorgen door één onderneming, heeft dit verschillende voor-en nadelen;</p>
                        ...
                        <p>Dit is enkel voor doe-het-zelvers, je kan je toestel en benodigdheden volledig zelf kiezen en aankopen, en zo goed als zelf installeren. Het enige wat je niet zelf kan doen, is het aansluiten van de koelleidingen.</p>
                        <p><span>let op! </span>Het is bij wet verplicht om de koelleidingen te laten aansluiten door een technieker met het certificaat koeltechnieken (STEK). Doe je dit toch zelf, dan valt je systeem niet onder garantie en eventuele schade veroorzaakt door je airco-systeem (bijvoorbeeld brand) wordt door de meeste verzekeringen NIET vergoed.</p>
                    ...
                    <div className="wizard-form-section">
                        <div className="wizard-form-section-step-container">
                            ...
                            <div className={"wizard-ac-type-thumb "+(query.install === 'auto'||query.install===false?"":"disabled")} onClick={() => updateQuery('install', 'auto')}>Alles</div>
                            <div className={"wizard-ac-type-thumb "+(query.install === 'semi'||query.install===false?"":"disabled")} onClick={() => updateQuery('install', 'semi')}>Enkel installatie en opstart</div>
                            <div className={"wizard-ac-type-thumb "+(query.install === 'manual'||query.install===false?"":"disabled")} onClick={() => updateQuery('install', 'manual')}>Enkel opstart</div>
                            <div className="wizard-next-step-container">
